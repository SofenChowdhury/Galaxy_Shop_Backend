    ...
    return (
        <Authenticated auth={props.auth} errors={props.errors}> 
            ...
            <div className="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
                <InfoCard title="Total Shop" value="1200">
                    <i className="fas fa-store text-5xl text-green-400 text-cool-purple-600"></i>
                </InfoCard>
                <InfoCard title="Total Orders" value="1200">
                    <i className="fas fa-bag-shopping text-5xl text-red-700 text-cool-purple-600"></i>
                </InfoCard>
                <InfoCard title="Total Customers" value="56">
                    <i className="fas fa-users text-5xl text-orange-400 text-cool-purple-600"></i>
                </InfoCard>
                <InfoCard title="Total Products" value="1200">
                    <i className="fas fa-bell text-5xl text-indigo-700 text-cool-purple-600"></i>
                </InfoCard>
            </div>
